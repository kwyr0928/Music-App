      ...
      return (
        <div className="flex flex-col items-center mt-10">
            ...
            <div className="inline-flex items-center space-x-4">
                <Select focusBorderColor="blue.500" placeholder="曲名を選択してください" onChange={handleSelectChange}>
                    <Option value="かえるのうた">かえるのうた</Option>
                    <Option value="キラキラ星">キラキラ星</Option>
                    <Option value="オリジナル">オリジナル</Option>
                </Select>
                <Button size="lg" colorScheme="primary" onClick={handleClick}>演奏開始</Button>
            </div>
        </div>
    );
}
